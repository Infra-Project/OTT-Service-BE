pipeline {
  ...
  stages {
    ...
    stage('Checkout Application Git Branch') {
      steps {
        checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: githubCredential, url: 'https://github.com/Infra-Project/OTT-Service-BE.git']]])
      }
      post {
        failure {
    ...
    stage('K8S Manifest Update') {
      steps {
        ...
        sh "git remote add origin https://github.com/Infra-Project/OTT-Service-BE.git"
